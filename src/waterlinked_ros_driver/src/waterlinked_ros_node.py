...
def waterlinked(base_url):
    ...
    raw_pub = rospy.Publisher('/waterlinked/acoustic_position/raw', PointStamped, queue_size = 120)
    filtered_pub = rospy.Publisher('/waterlinked/acoustic_position/filtered', PointStamped, queue_size = 120)
    global_pub = rospy.Publisher('/waterlinked/global_position', NavSatFix, queue_size = 120)
...
if __name__ == '__main__':
    try:
        ...
        #parser.add_argument('-u', '--url', help='Base URL to use', type=str, default='http://192.168.2.94')
        #args = parser.parse_args()
        base_url = 'http://192.168.2.94' #args.url
